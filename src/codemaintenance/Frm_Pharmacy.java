    	...
    	for ( int i = 0 ;i < dtm.getRowCount(); i++){
    		...
    		if(changed.compareTo("Y") == 0 || changed.compareTo("A") == 0) {
    			...
    			try {
					...
					if(effective != null && !effective.isEmpty()) prestate.setFloat(8, Integer.parseInt(effective)); else prestate.setNull(8, java.sql.Types.BIT);
					if(sort != null && !sort.isEmpty()) prestate.setFloat(9, Integer.parseInt(sort)); else prestate.setNull(9, java.sql.Types.INTEGER);
